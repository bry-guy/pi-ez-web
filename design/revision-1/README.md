...
| `--red` | `oklch(0.685 0.158 24)` | Diff deletions, stop hover |
...
- `design/Pi App.dc.html` — the full prototype. Open in a browser.
- `design/support.js` — runtime for the prototype only. **Not part of the deliverable.**
