...
| Worktree creation/removal and main-worktree safety | `server-project.test.js`, `workspaces.test.js` |
| Git context discovery and branch/worktree mechanics | `workspaces.test.js` |
...
The lifecycle tests keep all close, merge, refusal, conflict, and parent/child archival assertions. Each test gets a fresh server and repository through `helpers/lifecycle-fixture.js`, preventing repository inventories from accumulating across cases.
